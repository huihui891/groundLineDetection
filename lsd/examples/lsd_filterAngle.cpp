...
const float minA = 100;
const float maxA = 130;
...
int main(int argc, char *argv[])
{
    ...
    ls->filterOutAngle(lines,filtered_lines, minA,maxA);     // remove all vertical lines
    ls->retainAngle(lines, retained_lines, minA, maxA);       // take all vertical lines
